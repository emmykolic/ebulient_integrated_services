...
class vehicles extends boiler
{
    ...
    public function  defaultb($start = 0)
    {
        ...
        include_once 'themes/' . $this->setting->admin_theme . '/vehicles.php';
    ...
    {
        $this->auth->admin();
        $this->page_title = "Add New Vehicle";
        $this->set_token();
        include_once 'themes/' . $this->setting->admin_theme . '/header.php';
        include_once 'themes/' . $this->setting->admin_theme . '/vehicles_add.php';
        include_once 'themes/' . $this->setting->admin_theme . '/footer.php';
    }
    ...
    public function  edit($vid)
    {
        ...
        include_once 'themes/' . $this->setting->admin_theme . '/header.php';
        include_once 'themes/' . $this->setting->admin_theme . '/vehicles_edit.php';
        include_once 'themes/' . $this->setting->admin_theme . '/footer.php';
    }
