<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Managers/Driver/</span> Latest</h4>
                ...
                <div class="card p-2 px-md-5 pb-md-5">
                    ...
                    <div class="card-header pb-0 mb-3">
                        <div class="row d-flex align-items-end justify-content-between">
                            ...
                            <a href="<?= BURL ?>users/add" class="btn btn-success ms-auto col-md-2 col-sm-3 col-12"> Add Manager/Driver</a>
                        </div>
                    </div>
                    <?php if ($num > 0) : ?>
                                                    ...
                                                    <div class="d-flex px-2 py-1">
                                                        ...
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <h6 class="mb-0 text-sm">
                                                                <?= $row['fullname'] ?> ( <?= ($row['type'] == 5) ? 'Manager' : 'Driver' ?> )<br>
                    ...
                    <?php else : ?>
                        <div class="alert alert-warning"> No Drivers or Managers Found! </div>
                    <?php endif; ?>
                </div>
            </div>
        </div>
