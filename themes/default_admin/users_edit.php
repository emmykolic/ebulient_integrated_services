...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Users/</span> Edit Manager or Driver</h4>
            ...
            <div class="col-md-8 offset-md-2 col-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Edit Manager Or Driver Account</h5>
                    </div>
                    <div class="card-body">
                        <form id="formAuthentication" class="mb-3" action="<?= BURL ?>users/edit_action" method="POST" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="fullname" placeholder="Enter your Full Name" value="<?= $person['fullname'] ?>" required />
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select type="text" class="form-control" id="type" name="account_type" required>
                                    <option value="<?= $person['type'] ?>"><?= ($person['type'] == 4) ? "Driver" : "Manager" ?></option>
